  ...
  if ($uploadOk == 0) {
      ...
      if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
          ...
          if (isset($_REQUEST['add'])) {
            $formation = new formation(1, $_POST['sujet'],$_POST['type'],$_POST['adresse'], $_POST['categorie'], $target_file ,$_POST['prix'],$_POST['duree'],$_POST['datef'],$_SESSION['id']);
            $formationC->ajouterformation($formation);
           
            header('Location:ajouterformation.php');
          } else if (isset($_REQUEST['edit'])) {
          $formation = new formation($_POST['id'], $_POST['sujet'],$_POST['type'],$_POST['adresse'], $_POST['categorie'], $target_file, $_POST['prix'],$_POST['duree'],$_POST['datef'],$_SESSION['id']);
