    ...
    Class formationC {
        ...
        function ajouterformation($formation)
        {
            ...
            try {
                ...
                (titre,type,adresse ,categorie, img, prix, duree, datef,idf )
                VALUES
                (:titre,:type,:adresse, :categorie, :img, :prix, :duree, :datef, :idf)
                ');
        ...
        function modifierformation($formation)
        {
            ...
            try {
                ...
                titre=:titre,type=:type,adresse=:adresse,categorie=:categorie,img=:img,prix=:prix,duree=:duree,datef=:datef
                where id=:id');
